...
class teacher                /////////////// Starting of TEACHER Class Derived From STAFF Class ////////////
{
 protected:
  ...
  char publication[30];
 public:
  staff staff_member;                 //////////////////// Container Class Example ///////////////////////
  education staff_education;          //////////////////// Container Class Example ///////////////////////
...
class officer               ////////////////// Starting of OFFICER Class Derived From STAFF Class ////////////
{
 protected:
  char grade;
...
class typist             /////////////////// Starting of TYPIST Class Derived From STAFF Class ////////////
{
 protected:
  int speed;
...
class regular          ///////////////// Starting of REGULAR Class Derived From TYPIST Class /////////////
{
 protected:
  static int regular_typist_count;
 public:
  typist typist_type;          //////////////////// Container Class Example ///////////////////////
...
class casual          //////////////// Starting of CASUAL Class Derived From TYPIST Class ///////////////
{
 protected:
			...
			case 1 :  {                                               /////////// Starting of CASE 1 //////////////////
							...
							while(j)                                     //////// Starting of While Loop //////////////////
							{
								...
								cin>>ch;
									...
									{
										case 1 : teacher obj1;
													obj1.staff_member.input_code();
													obj1.staff_member.input_name();
													obj1.input_subject();
													obj1.input_publication();
													obj1.staff_education.input_education_details();
										...
										case 2 : {
														 ...
														 proceed=teacher :: check_teacher_count();
															...
															{
																obj1.staff_member.output_code();
																obj1.staff_member.output_name();
																obj1.output_subject();
																obj1.output_publication();
																obj1.staff_education.output_education_details();
															}
													break;
													}
			...
			case 2 :  {                                               /////////// Starting of CASE 2 //////////////////
							...
							while(j)                                     //////// Starting of While Loop //////////////////
							{
								...
								cin>>ch;
									...
									{
										case 1 : officer obj2;
													obj2.staff_member.input_code();
													obj2.staff_member.input_name();
													obj2.input_grade();
													obj2.staff_education.input_education_details();
										...
										case 2 : {
														...
														proceed=officer :: check_officer_count();
															...
															{
																obj2.staff_member.output_code();
																obj2.staff_member.output_name();
																obj2.output_grade();
																obj2.staff_education.output_education_details();
															}
													break;
													}
																...
																cin>>choose;
																	switch(choose)                   ///////// Starting of Switch /////////////
																	{
																		case 1 : {                   ////////// Starting of CASE 1 /////////////
																						regular obj3;
																						next;
																						obj3.typist_type.staff_member.input_code();
																						obj3.typist_type.staff_member.input_name();
																						obj3.typist_type.input_speed();
																							...
																							cin>>ask;
																								switch(ask)        ////////////// Starting of Switch ///////////////
																								{
																									case 1 : {
																													...
																													{
																														obj3.typist_type.staff_member.output_code();
																														obj3.typist_type.staff_member.output_name();
																														obj3.typist_type.output_speed();
																													}
																												break;
																												}
