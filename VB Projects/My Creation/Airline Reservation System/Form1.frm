...
con.Execute ("insert into ulog values(' " & X & " ',' " & Text1.Text & " ',' " & Text2.Text & " ',' " & Now & " ',' " & Format(Now, "dddd") & " ',' Administrator ')")
MsgBox "Login Successful", vbInformation, "Airline Reservation System"
rst2.Close
rst3.Close
rst4.Close
con.Close
...
Text2.Text = Clear
Text2.SetFocus
Else: MsgBox "Login Successful", vbInformation, "Airline Reservation System"
con.Execute ("insert into ulog values(' " & X & " ',' " & Text1.Text & " ',' " & Text2.Text & " ',' " & Now & " ',' " & Format(Now, "dddd") & " ',' Local User ')")
rst2.Close
rst3.Close
rst4.Close
con.Close
