...
con.Open
con.Execute "insert into msattendance values(' " & DTPicker1.Value & " ','Present')"
con.Close
...
con.ConnectionString = "provider=microsoft.jet.oledb.4.0;data source=C:\Users\Lucky\Desktop\My Project\faculty.mdb"
con.Open
con.Execute "insert into msattendance values(' " & DTPicker1.Value & " ','Absent')"
con.Close
